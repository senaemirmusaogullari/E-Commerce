...
public final class FragmentFavoritesBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvFavProducts;
  ...
  private FragmentFavoritesBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ProgressBar progressBar, @NonNull RecyclerView rvFavProducts,
      @NonNull TextView tvClear, @NonNull TextView tvError) {
    this.rootView = rootView;
    this.detailToolbar = detailToolbar;
    this.ivBack = ivBack;
    this.ivError = ivError;
    this.progressBar = progressBar;
    this.rvFavProducts = rvFavProducts;
  ...
  public static FragmentFavoritesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rv_fav_products;
      RecyclerView rvFavProducts = ViewBindings.findChildViewById(rootView, id);
      if (rvFavProducts == null) {
        break missingId;
      }
      ...
      return new FragmentFavoritesBinding((ConstraintLayout) rootView, detailToolbar, ivBack,
          ivError, progressBar, rvFavProducts, tvClear, tvError);
    }
