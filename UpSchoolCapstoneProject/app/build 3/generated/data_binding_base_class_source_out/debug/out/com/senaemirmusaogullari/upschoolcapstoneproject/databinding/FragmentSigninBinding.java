...
public final class FragmentSigninBinding implements ViewBinding {
  ...
  private FragmentSigninBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSignin,
      ...
      @NonNull ImageView imageView2, @NonNull ProgressBar progressBar, @NonNull TextView textView5,
  ...
  public static FragmentSigninBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSigninBinding((ConstraintLayout) rootView, btnSignin, etEmail, etPassword,
          imageView2, progressBar, textView5, tilEmail, tilPassword, tvForgot, tvSignUp, tvTitle);
    }
