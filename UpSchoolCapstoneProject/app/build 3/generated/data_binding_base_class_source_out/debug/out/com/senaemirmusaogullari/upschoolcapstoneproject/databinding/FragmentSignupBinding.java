...
public final class FragmentSignupBinding implements ViewBinding {
  ...
  private FragmentSignupBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSignUp,
      ...
      @NonNull TextInputEditText etVerifyPassword, @NonNull ImageView imageView,
      @NonNull ProgressBar progressBar, @NonNull TextView textView,
      @NonNull TextInputLayout tilEmail, @NonNull TextInputLayout tilNickname,
      @NonNull TextInputLayout tilPassword, @NonNull TextInputLayout tilPhone,
      @NonNull TextInputLayout tilVerifyPassword) {
  ...
  public static FragmentSignupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSignupBinding((ConstraintLayout) rootView, btnSignUp, etEmail, etNickname,
          etPassword, etPhone, etVerifyPassword, imageView, progressBar, textView, tilEmail,
          tilNickname, tilPassword, tilPhone, tilVerifyPassword);
    }
