...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivFavorites,
      @NonNull ImageView ivProduct, @NonNull TextView tvPrice, @NonNull TextView tvSalePrice,
      @NonNull TextView tvTitle) {
    this.rootView = rootView;
    this.ivFavorites = ivFavorites;
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.iv_favorites;
      ImageView ivFavorites = ViewBindings.findChildViewById(rootView, id);
      if (ivFavorites == null) {
        break missingId;
      }
      ...
      return new ItemProductBinding((ConstraintLayout) rootView, ivFavorites, ivProduct, tvPrice,
          tvSalePrice, tvTitle);
    }
